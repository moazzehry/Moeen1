...
function showMapInfo(place, isAuto = false) {
  ...
  if (userMarker) {
    ...
    if (place === 'user') {
      ...
      userMarker.style.top = '60px';
      userMarker.style.left = '10%';
    } else if (place === 'marwa') {
      userMarker.style.top = '290px'; // height is 350px, bottom 60px is top 290px
      userMarker.style.left = '10%';
    } else if (place === 'maqam') {
      userMarker.style.top = '120px';
      userMarker.style.left = 'calc(50% - 60px)';
    }
  }
